...
dag = DAG(
    dag_id='kbu1_mtc_jigs_spare_part_pipeline',
    default_args=default_args,
    description='ETL pipeline untuk spare part maintenance jigs',
    schedule='0 9 * * *',
    catchup=False,
)

# ========== Path & Table ==========
RAW_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Maintenance Jigs/Excel Online/kbu1_mtc_jigs_sparepart_bronze.xlsx"
BRONZE_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Maintenance Jigs/Extract Data/kbu1_mtc_jigs_sparepart_bronze.xlsx"
SILVER_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Maintenance Jigs/Silver Data/kbu1_mtc_jigs_sparepart_silver.xlsx"
TABLE_BRONZE = "kbu1_mtc_jigs_sparepart_bronze"
TABLE_SILVER = "kbu1_mtc_jigs_sparepart_silver"
...
def extract_jigs_spare_part():
    extractor = JigsSparePartExtractor(RAW_PATH, BRONZE_PATH)
    extractor.extract()
    save_excel_to_postgres(BRONZE_PATH, TABLE_BRONZE, 'bronze')

def transform_jigs_spare_part():
    transformer = JigsSparePartTransformer(BRONZE_PATH, SILVER_PATH)
...
t1 = PythonOperator(
    task_id='extract_jigs_spare_part',
    python_callable=extract_jigs_spare_part,
    dag=dag,
    on_failure_callback=notify_teams,
...
t2 = PythonOperator(
    task_id='transform_jigs_spare_part',
    python_callable=transform_jigs_spare_part,
    dag=dag,
    on_failure_callback=notify_teams,
