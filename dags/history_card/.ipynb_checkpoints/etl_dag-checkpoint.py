...
from etl_history_card.extract import HCMExtractor
from etl_history_card.transform import HCMTransformer
...
dag = DAG(
    'kbu1_mtc_history_card_pipeline',
    default_args=default_args,
    description='ETL pipeline untuk Maintenance History Card Machine',
    schedule='0 9 * * *',  # setiap jam 8 pagi
    catchup=False,
)
...
# Path Configuration
# ====================
RAW_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/History Card/Excel Online/kbu1_mtc_history_card_bronze.xlsx"
BRONZE_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/History Card/Extract Data/kbu1_mtc_history_card_bronze.xlsx"
SILVER_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/History Card/Silver Data/kbu1_mtc_history_card_silver.xlsx"
TABLE_BRONZE = "kbu1_mtc_history_card_bronze"
TABLE_SILVER = "kbu1_mtc_history_card_silver"
...
def extract_hcm():
    extractor = HCMExtractor(RAW_PATH, BRONZE_PATH)
    extractor.extract()
    save_excel_to_postgres(BRONZE_PATH, TABLE_BRONZE, 'bronze')

def transform_hcm():
    transformer = HCMTransformer(BRONZE_PATH, SILVER_PATH)
...
t2 = PythonOperator(
    task_id='transform_hcm',
    python_callable=transform_hcm,
    dag=dag,
