...
from etl_mtc_jigs.extract import MTCJigsExtractor
from etl_mtc_jigs.transform import MTCJigsTransformer
...
dag = DAG(
    'kbu1_mtc_jigs_pipeline',
    default_args=default_args,
    description='ETL pipeline untuk Maintenance Jigs',
...
# Path Configuration
# ====================
RAW_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Maintenance Jigs/Excel Online/kbu1_mtc_jigs_report_bronze.xlsx"
BRONZE_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Maintenance Jigs/Extract Data/kbu1_mtc_jigs_report_bronze.xlsx"
SILVER_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Maintenance Jigs/Silver Data/kbu1_mtc_jigs_report_silver.xlsx"
TABLE_BRONZE = "kbu1_mtc_jigs_bronze"
TABLE_SILVER = "kbu1_mtc_jigs_silver"
...
def extract_mtc_jigs():
    extractor = MTCJigsExtractor(RAW_PATH, BRONZE_PATH)
    extractor.run().save_to_excel()
    save_excel_to_postgres(BRONZE_PATH, TABLE_BRONZE, 'bronze')

def transform_mtc_jigs():
    transformer = MTCJigsTransformer(BRONZE_PATH, SILVER_PATH)
...
t1 = PythonOperator(
    task_id='extract_mtc_jigs',
    python_callable=extract_mtc_jigs,
    dag=dag,
...
t2 = PythonOperator(
    task_id='transform_mtc_jigs',
    python_callable=transform_mtc_jigs,
    dag=dag,
