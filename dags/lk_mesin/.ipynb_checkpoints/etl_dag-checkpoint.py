...
from etl_lk_mesin.extract import MTCExtractor
from etl_lk_mesin.transform import MTCTransformer
...
dag = DAG(
    'kbu1_mtc_lk_mesin_pipeline',
    default_args=default_args,
    description='ETL pipeline untuk LK Mesin Maintenance',
...
# Path Configuration
# ====================
RAW_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Logbook LK/Excel Online/kbu1_mtc_lk_mesin_req.xlsx"
BRONZE_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Logbook LK/Extract Data/kbu1_mtc_lk_mesin_bronze.xlsx"
SILVER_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Logbook LK/Silver Data/kbu1_mtc_lk_mesin_silver.xlsx"
TABLE_BRONZE = "kbu1_mtc_lk_mesin_bronze"
TABLE_SILVER = "kbu1_mtc_lk_mesin_silver"
...
def extract_lk_mesin():
    extractor = MTCExtractor(RAW_PATH, BRONZE_PATH)
    extractor.load_data()\
...
def transform_lk_mesin():
    transformer = MTCTransformer(BRONZE_PATH, SILVER_PATH)
...
t1 = PythonOperator(
    task_id='extract_lk_mesin',
    python_callable=extract_lk_mesin,
    dag=dag,
...
t2 = PythonOperator(
    task_id='transform_lk_mesin',
    python_callable=transform_lk_mesin,
    dag=dag,
