...
from etl_sparepart_dies.extract import StockSparePartExtractor
from etl_sparepart_dies.transform import StockSparePartTransformer
...
dag = DAG(
    dag_id='kbu1_mtc_spare_part_pipeline',
    default_args=default_args,
    description='ETL pipeline untuk stock spare part maintenance dies',
    schedule='0 9 * * *',
    catchup=False,
)

RAW_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Maintenance Dies/Excel Online/kbu1_mtc_stock_spare_part_bronze.xlsx"
BRONZE_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Maintenance Dies/Extract Data/kbu1_mtc_stock_spare_part_bronze.xlsx"
SILVER_PATH = "/opt/airflow/sharepoint_defect_tracker/KBU1/Maintenance Dept/Maintenance Dies/Silver Data/kbu1_mtc_stock_spare_part_silver.xlsx"
TABLE_BRONZE = "kbu1_mtc_stock_spare_part_bronze"
TABLE_SILVER = "kbu1_mtc_stock_spare_part_silver"
...
def extract_stock_spare_part():
    extractor = StockSparePartExtractor(RAW_PATH, BRONZE_PATH)
    extractor.extract()
    save_excel_to_postgres(BRONZE_PATH, TABLE_BRONZE, 'bronze')

def transform_stock_spare_part():
    transformer = StockSparePartTransformer(BRONZE_PATH, SILVER_PATH)
...
t1 = PythonOperator(
    task_id='extract_stock_spare_part',
    python_callable=extract_stock_spare_part,
    dag=dag,
    on_failure_callback=notify_teams,
...
t2 = PythonOperator(
    task_id='transform_stock_spare_part',
    python_callable=transform_stock_spare_part,
    dag=dag,
    on_failure_callback=notify_teams,
