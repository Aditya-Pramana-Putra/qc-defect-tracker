...
class HCMTransformer:
    ...
    def fill_missing_data(self):
        ...
        # Mengisi NaN untuk kolom numerik dengan 0, lalu ubah ke integer
    ...
    def reorder_columns(self):
        # Mengurutkan ulang kolom agar rapi (jika diperlukan)
        desired_order = [
            'machine_no', 'machine_name', 'type_or_model_machine', 'serial_no',
            'num_of_capacity', 'capacity_unit', 'maker', 'country',
            'month', 'year', 'motor_type', 'lubricant_use', 'other_information'
        ]
        self.df = self.df[[col for col in desired_order if col in self.df.columns]]
        return self
